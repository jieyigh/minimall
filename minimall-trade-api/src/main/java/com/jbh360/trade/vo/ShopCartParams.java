...
public class ShopCartParams implements Serializable{ 
	...
	private String customer_member_mobile;	// 手机号
	
	@NotNull(groups={ShopCartListParams.class,ShopCartAddParams.class},message="store_id不能为空")
	...
	@NotBlank(message = "barcode不能为空",groups={ShopCartAddParams.class})
	private String product_barcode; 	// 产品barcode
	
	private String version_no;			// 版本号
	
	private String shop_car_token;	// 未登录的tocken
	
	private String access_token;	// 登陆后的tocken
	
	private String sku_properties_name;
	
	@NotNull(groups = {ShopCartAddParams.class,ShopCartUpdateParams.class},message="buy_count不能为空")
	@Range(min=1,max=9999,groups={ShopCartAddParams.class,ShopCartUpdateParams.class})
	private Integer buy_count;
	
	@NotEmpty(groups = {ShopCartAddParams.class},message="单价不能为空")
	@Money(groups = {ShopCartAddParams.class})
	private String product_unit_price;
	
	@NotNull(groups = {ShopCartUpdateParams.class},message="shop_cart_id不能为空")
	...
	public String getShop_car_token() {
		return shop_car_token;
	}


	public void setShop_car_token(String shop_car_token) {
		this.shop_car_token = shop_car_token;
	}
