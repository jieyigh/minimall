...
import com.jbh360.common.base.Member;
 ...
 * @version V3.0
 */
public class OrderServiceParams extends Member{
	
	/**
	 * @Fields serialVersionUID : TODO(用一句话描述这个变量表示什么)
	 */
	private static final long serialVersionUID = 5711112321711829668L;
	...
	private String deal_type;// 处理方式(期望结果)（refund我要退款 ，但不退货 return我要退款并退货）
