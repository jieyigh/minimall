...
public class OrderExpressServiceImpl {
	...
	public Page<OrderExpressResult> getOrderExpressResults(Page<OrderExpressResult> page, OrderExpressParams params){
		...
		for(OrderExpressVo expressVo:expressVos){
			...
			setExpressInfo(orderExpressResult);
	...
	public OrderExpressResult getOrderExpressResult(OrderExpressParams params,ErrorResult error){
		...
		Long orderId = orderExpressResult.getFkOrderId();
		if(orderId != null){
			Order order = this.orderMapper.selectByPrimaryKey(orderId);
			if(order != null && order.getOrderType() != null){
				orderExpressResult.setOrderType(order.getOrderType());
			}
		}
	...
	private void setExpressInfo(OrderExpressResult orderExpressResult) {
		...
		criteria.andFkOrderExpressIdEqualTo(orderExpressResult.getId());
		...
		followcriteria.andFkOrderExpressIdEqualTo(orderExpressResult.getId());
