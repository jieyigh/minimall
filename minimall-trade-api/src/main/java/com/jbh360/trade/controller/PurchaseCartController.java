...
import com.jbh360.trade.vo.PurchaseCartParams.PurchaseCartUpdateBatchValid;
import com.jbh360.trade.vo.PurchaseCartParams.PurchaseCartUpdateValid;
import com.jbh360.trade.vo.PurchaseCartResult;
import com.jbh360.trade.vo.PurchaseCartUpdateBatchResponseTag;
...
public class PurchaseCartController {
	 ...
	 * 批量更新采购车
	 * @author : liguosheng 
	 * @CreateDate : 2015年11月4日 上午10:45:21 
	 * @param params
	 * @param bindingResult
	 * @return
	 */
	...
	@ResponseBody
	public Object updateBatch(@Validated({PurchaseCartUpdateBatchValid.class}) PurchaseCartParams params,BindingResult bindingResult) {
		
		ErrorResult errorResult = new ErrorResult();
		ErrorResultResponseTag errorResopneTag= new ErrorResultResponseTag();
		
		PurchaseCartUpdateBatchResponseTag cartUpdateResponseTag = new PurchaseCartUpdateBatchResponseTag();
		SuccessResult successResult = null;
		...
		try {
			...
			// 业务逻辑方法
			successResult = this.purchaseCartServiceImpl.updatePurchaseCartBatch(params);
