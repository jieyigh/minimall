...
* @version V3.0  
*/
public class WapTradeParam implements Serializable{
	 
	private static final long serialVersionUID = 1L;
	@NotNull(message="用户id不能为空")
	private Long member_id;
	
	@NotNull(message="交易单类型不能为空")
	...
	@NotBlank(message="收货人手机号receiver_type不能为空")
	...
	public List<WapOrderParam> getOrders() {
		return orders;
	}
	...
	public void setOrders(List<WapOrderParam> orders) {
		this.orders = orders;
	}
