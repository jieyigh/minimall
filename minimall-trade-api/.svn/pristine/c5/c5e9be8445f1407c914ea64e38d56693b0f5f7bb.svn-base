...
public class OrderServiceResult {
	...
	private	Short refundReasonTypeId;
	...
	public Short getRefundReasonTypeId() {
		return refundReasonTypeId;
	}

	public void setRefundReasonTypeId(Short refundReasonTypeId) {
		this.refundReasonTypeId = refundReasonTypeId;
	}
